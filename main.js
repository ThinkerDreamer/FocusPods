...
const firebaseConfig = {
  ...
  databaseURL:
    "https://focus-button-default-rtdb.europe-west1.firebasedatabase.app",
...
themeButton.addEventListener("click", function () {
  ...
  currentMode =
    themeButton.textContent === `Dark mode` ? modes.pastel : modes.dark;
...
angelButton.addEventListener("click", function () {
  getData("angel");
});
lucaButton.addEventListener("click", function () {
  getData("luca");
});
